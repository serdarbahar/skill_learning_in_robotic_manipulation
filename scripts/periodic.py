import numpy as np
from src.periodic_warping.periodic_warping_model import PeriodicWarpingModel
...
def run_experiment():
    ...
    c_query_vals = np.array([
        0.5,
        1.0,
        #2.5,    # strong extrapolation
        #-2.0,   # negative extrapolation
        #4.0,    # extreme extrapolation
    ...
    model_pw = PeriodicWarpingModel(
        period_c = np.array([2], dtype=np.float32),  
